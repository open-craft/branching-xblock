...
"""
branching-xblock documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'branching-xblock',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/open-craft/branching-xblock",
...
#
# html_title = 'branching-xblock v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'Branching Scenario XBlock',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'branching_xblock'),
                os.path.join(root_path, 'branching_xblock/migrations')])
