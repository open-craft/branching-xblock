#!/usr/bin/env python
"""
Package metadata for branching_xblock.
"""
import os
import re
import sys
...
VERSION = get_version('branching_xblock', '__init__.py')
...
setup(
    name='branching-xblock',
    version=VERSION,
    description="""Branching Scenario XBlock""",
    long_description=README + '\n\n' + CHANGELOG,
    author='OpenCraft',
    author_email='help+xblock@opencraft.com',
    url='https://github.com/open-craft/branching-xblock',
    packages=find_packages(
        include=['branching_xblock', 'branching_xblock.*'],
        exclude=["*tests"],
    ),
    ...
    entry_points={
        'xblock.v1': [
            'branching_xblock = branching_xblock:BranchingXBlock',
        ]
    },
    package_data=package_data("branching_xblock", ["static", "public", "templates/html/*.html"]),
